...
namespace DentalClinicManagementWinForm
{
    public partial class Appointment : Form
    {
        ...
        {
            string query = "insert into AppointmentTbl values('" + PatientCb.SelectedValue.ToString() + "', '" + TreatmentCb.SelectedValue.ToString() + "','" + Date.Value.ToString("yyyy-MM-dd") + "','"+Time.Value.TimeOfDay+"')";
            Appointments appointment = new Appointments();
            try
            {
